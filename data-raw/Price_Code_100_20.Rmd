...
va_med_and_min_prices.subset.tr <- get_data.subset(va_bg_broadband_now_prices, county = F, tract = T)
dc_med_and_min_prices.subset.tr <- get_data.subset(dc_bg_broadband_now_prices, county = F, tract = T)
md_med_and_min_prices.subset.tr <- get_data.subset(md_bg_broadband_now_prices, county = F, tract = T)
dmv_med_and_min_prices.subset.tr <- get_data.subset(dmv_bg_broadband_now_prices, county = F, tract = T)

va_med_and_min_prices.subset.bg <- get_data.subset(va_bg_broadband_now_prices, county = F, tract = F)
dc_med_and_min_prices.subset.bg <- get_data.subset(dc_bg_broadband_now_prices, county = F, tract = F)
md_med_and_min_prices.subset.bg <- get_data.subset(md_bg_broadband_now_prices, county = F, tract = F)
dmv_med_and_min_prices.subset.bg <- get_data.subset(dmv_bg_broadband_now_prices, county = F, tract = F)
```
...
va_prices.subset.ct <- va.ct %>% left_join(va_med_and_min_prices.subset.ct, by = c("GEOID" = "county"))
va_prices.subset.tr <- va.ct %>% left_join(va_med_and_min_prices.subset.tr, by = c("GEOID" = "tract"))
va_prices.subset.bg <- va.bg %>% left_join(va_med_and_min_prices.subset.bg, by = c("GEOID" = "block_group"))

dc_prices.subset.ct <- dc.ct %>% left_join(dc_med_and_min_prices.subset.ct, by = c("GEOID" = "county"))
dc_prices.subset.tr <- dc.tr %>% left_join(dc_med_and_min_prices.subset.tr, by = c("GEOID" = "tract"))
dc_prices.subset.bg <- dc.bg %>% left_join(dc_med_and_min_prices.subset.bg, by = c("GEOID" = "block_group"))

md_prices.subset.ct <- md.ct %>% left_join(md_med_and_min_prices.subset.ct, by = c("GEOID" = "county"))
md_prices.subset.tr <- md.tr %>% left_join(md_med_and_min_prices.subset.tr, by = c("GEOID" = "tract"))
md_prices.subset.bg <- md.bg %>% left_join(md_med_and_min_prices.subset.bg, by = c("GEOID" = "block_group"))
```
